            ...
            <div>
                ...
                <div className="keskitetty">
                    <div className="polkulista">
                        ...
                        <ul>
                            <li><a className="LinkText" href="https://eperusteet.opintopolku.fi/#/fi/esitys/3855075/reformi/tutkinnonosat/3906424" target="_blank">2.11. Koneistus, 30 osp</a> (pakollinen tutkinnonosa)</li>
