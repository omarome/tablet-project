...
class Koneautomaatioasentajapolku extends Component {

    render() {
        return (
            <div>
                <div>
                    <h1 className="HeaderFont display-3 mt-4" >Koneautomaatioasentajan polku</h1>
                </div>
                ...
                <div className="keskitetty">
                    <div className="polkulista">
                        ...
                        <ul>
                            <li><a className="LinkText" href="https://eperusteet.opintopolku.fi/#/fi/esitys/3855075/reformi/tutkinnonosat/3906200" target="_blank">2.11. Koneautomaatioasennus, 30 osp</a> (pakollinen tutkinnonosa)</li>
...
export default Koneautomaatioasentajapolku;