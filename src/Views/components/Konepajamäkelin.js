...
class Konepajamäkelin extends Component {
        ...
        return (
          <div className="Main container-fluid">
            ...
            <div className="kotisivu">
              <p>Yrityksen kotisivut: <a className="LinkText" href="https://www.konepajamakelin.fi/" target="_blank">Konepajamäkelin</a></p>
            </div>
          </div>
        );
      }
...
export default Konepajamäkelin;